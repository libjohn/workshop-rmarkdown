...
[Rfun](https://rfun.library.duke.edu): An R Learning Series
...
1. Literate Code:  R Markdown with R code chunks

    - code chunks
    - inline code
    - LaTex Equations $\bar{X}=\frac{1}{n}\sum_{i=1}^nX_i$

1. Slides:  DukeSlides (A Xaringan implementation)
1. MS Word:  (using knitr::kable for tables)
1. Book:  Bookdown
1. Dashboard:  Flex Dashboards
1. Website:  Blogdown
